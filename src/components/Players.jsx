    ...
    <section className="py-20 px-4 md:px-8 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-6 animate-slide-up">
          {/* Carlos Caszely */}
          <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-black hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
          ...
          {/* Elías Figueroa */}
          <div className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg border-l-4 border-gray-600 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            <div className="flex items-center gap-4 mb-4">
              <span className="text-4xl">⭐</span>
